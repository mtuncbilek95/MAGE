    ...
    namespace VkUtils {
        ...
        static HashMap<TextureFormat, VkFormat> GetVkFormatMap() {
            ...
            for (auto format: magic_enum::enum_values<TextureFormat>()) {
                ...
                else if (format == TextureFormat::BGRA8_UNorm)
                    formatMap[format] = VK_FORMAT_B8G8R8A8_UNORM;
                else if(format == TextureFormat::BGRA8_UInt)
                    formatMap[format] = VK_FORMAT_B8G8R8A8_UINT;
                else if (format == TextureFormat::BGRA8_Norm)
                    formatMap[format] = VK_FORMAT_B8G8R8A8_SNORM;
                else if (format == TextureFormat::BGRA8_Int)
                    formatMap[format] = VK_FORMAT_B8G8R8A8_SINT;
                else if (format == TextureFormat::BGRA8_SRGB)
                    formatMap[format] = VK_FORMAT_B8G8R8A8_SRGB;
        ...
        static VkFormat GetVkFormat(TextureFormat format) {
            switch (format) {
                ...
                case TextureFormat::BGRA8_Norm: return VK_FORMAT_B8G8R8A8_SNORM;
                case TextureFormat::BGRA8_Int: return VK_FORMAT_B8G8R8A8_SINT;
